...
class UdCommand(alfredo.Plugin):
    ...
    def help(self):
        return ("Searches any term on urbandictionary.com",
                "Just call ud <term> and you will se the first available definition as returned by urbandictionary, and a link to the full result page.")
